  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-24 min-h-[100dvh]">
      ...
      <div className="prose prose-invert max-w-none text-white/70">
        ...
        <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">Log Files</h2>
        <p className="mb-4">Animxer follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>
        
        <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">Cookies and Web Beacons</h2>
        <p className="mb-4">Like any other website, Animxer uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
        
        <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">Third-Party Privacy Policies</h2>
        <p className="mb-4">Animxer's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.</p>
        ...
        <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">Children's Information</h2>
        ...
        <p className="mb-4">Animxer does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
        
        <h2 className="text-xl md:text-2xl font-bold text-white mt-8 mb-4">Consent</h2>
